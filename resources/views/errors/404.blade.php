...
<div class="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-b from-primary to-primary-light relative overflow-hidden">
    ...
    <div class="relative z-10 text-center max-w-lg bg-white/10 backdrop-blur-md p-8 sm:p-12 rounded-xl shadow-2xl border border-white/20">
        <h1 class="font-display text-7xl sm:text-9xl font-bold text-accent mb-4">404</h1>
        <h2 class="font-display text-xl sm:text-2xl font-medium text-white mb-6">Page Not Found</h2>
        <p class="text-white/80 mb-8">The celestial object you're seeking seems to have drifted beyond our galaxy. Let's navigate back to familiar stars.</p>
