...
<div class="container mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Edit Offer</h1>
            <p class="mt-1 text-sm text-gray-600">Update promotional offer details</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('admin.print.offer', $offer->id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors duration-200">
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="{{ route('admin.offers.update', $offer) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div id="content-en" class="tab-content space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">{{ old('description', $offer->description) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="tag" id="tag" value="{{ old('tag', $offer->tag) }}" placeholder="e.g. SPECIAL OFFER"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    </div>

                    <div>
                        <label for="discount_text" class="block text-sm font-medium text-gray-700">Discount Text</label>
                        <input type="text" name="discount_text" id="discount_text" value="{{ old('discount_text', $offer->discount_text) }}" placeholder="e.g. 25% OFF"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                ...
                <div>
                    ...
                    <input type="text" name="button_text" id="button_text" value="{{ old('button_text', $offer->button_text) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                </div>
            </div>
            ...
            <div id="content-ar" class="tab-content space-y-6 hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $offer->title_ar) }}" dir="rtl"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    </div>

                    <div>
                        <label for="subtitle_ar" class="block text-sm font-medium text-gray-700">Subtitle (Arabic)</label>
                        <input type="text" name="subtitle_ar" id="subtitle_ar" value="{{ old('subtitle_ar', $offer->subtitle_ar) }}" dir="rtl"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description_ar" id="description_ar" rows="3" dir="rtl"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">{{ old('description_ar', $offer->description_ar) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="tag_ar" id="tag_ar" value="{{ old('tag_ar', $offer->tag_ar) }}" dir="rtl"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    </div>

                    <div>
                        <label for="discount_text_ar" class="block text-sm font-medium text-gray-700">Discount Text (Arabic)</label>
                        <input type="text" name="discount_text_ar" id="discount_text_ar" value="{{ old('discount_text_ar', $offer->discount_text_ar) }}" dir="rtl"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="button_text_ar" id="button_text_ar" value="{{ old('button_text_ar', $offer->button_text_ar) }}" dir="rtl"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                </div>
            </div>
            ...
            <div class="pt-6 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="original_price" id="original_price" value="{{ old('original_price', $offer->original_price) }}" step="0.01" min="0"
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="discounted_price" id="discounted_price" value="{{ old('discounted_price', $offer->discounted_price) }}" step="0.01" min="0"
                                class="pl-7 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="stock" id="stock" value="{{ old('stock', $offer->stock) }}" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    ...
                    <div>
                        ...
                        <input type="number" name="low_stock_threshold" id="low_stock_threshold" value="{{ old('low_stock_threshold', $offer->low_stock_threshold) }}" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                ...
                <div class="mb-6 pt-6 border-t border-gray-200">
                    ...
                    <div id="bundle-products-container">
                        @if($offer->products->count() > 0)
                            @foreach($offer->products as $bundleProduct)
                            <div class="bundle-product-row grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 items-end">
                                <div>
                                    ...
                                    <select name="bundle_products[]" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 bundle-product-select">
                                        <option value="">-- Select a product --</option>
                                        @foreach($products as $product)
                                            <option value="{{ $product->id }}" {{ $bundleProduct->id == $product->id ? 'selected' : '' }}>
                                                {{ $product->name }} ({{ $currencySymbol }}{{ number_format($product->price, 2) }})
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="bundle_quantities[]" min="1" value="{{ $bundleProduct->pivot->quantity }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                                </div>
                                <div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="button_url" id="button_url" value="{{ old('button_url', $offer->button_url) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="datetime-local" name="starts_at" id="starts_at" value="{{ old('starts_at', $offer->starts_at ? $offer->starts_at->format('Y-m-d\TH:i') : '') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    </div>

                    <div>
                        <label for="expires_at" class="block text-sm font-medium text-gray-700">Expiry Date/Time</label>
                        <input type="datetime-local" name="expires_at" id="expires_at" value="{{ old('expires_at', $offer->expires_at ? $offer->expires_at->format('Y-m-d\TH:i') : '') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-2 mb-4">
                        ...
                        <div class="relative inline-block">
                            <img src="{{ asset($offer->image) }}" alt="{{ $offer->title }}" class="h-32 w-auto object-cover rounded-lg">
                            <input type="checkbox" name="delete_image" id="delete_image" value="1" class="absolute top-2 right-2 h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded">
                            <label for="delete_image" class="absolute top-2 right-8 bg-white text-red-600 text-xs px-2 py-1 rounded-md">Delete</label>
                        </div>
                    </div>
                    @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $offer->sort_order) }}" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addButton.addEventListener('click', function() {
            ...
            let firstRow;
            if (container.querySelector('.bundle-product-row')) {
                firstRow = container.querySelector('.bundle-product-row').cloneNode(true);
            } else {
                // Create a new row if none exists
                firstRow = document.createElement('div');
                firstRow.className = 'bundle-product-row grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 items-end';
                firstRow.innerHTML = `
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Product</label>
                        <select name="bundle_products[]" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 bundle-product-select">
